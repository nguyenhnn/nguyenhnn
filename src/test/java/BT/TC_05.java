...
public class TC_05 {
    ...
    public static void testTC05() {
        int scc=0;
        String firstName = "nguyen1";
        String lastName = "huynh";
        String email_address = "nguyenhuynh112@gmail.com";
        ...
        try{
            ...
            String png =("C:\\Users\\PC\\OneDrive\\Máy tính\\selenium-webdriver-java-master\\src\\test\\resources\\png/TC05_" + scc +".png");
